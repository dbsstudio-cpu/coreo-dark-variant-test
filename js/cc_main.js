...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // ---- 場景管理 ----
  const SCENARIOS = {
    s1: { stage: 1, exitDirection: 'down', cameraAnchorRatio: 0.12, label: 'STAGE 01', getMap: () => MazeLogic.getStage01Map() },
  ...
  function loadScenario(key) {
    ...
    CameraLogic.setDirection(sc.exitDirection, sc.cameraAnchorRatio);
    updatePlayerDOM();
